...
public class Operation implements KeyListener
{
    ...
    public void over()
    {
        ...
        {
            block[4].setText("G");
            block[4].setBackground(Color.ORANGE);
            block[5].setText("A");
            block[5].setBackground(Color.ORANGE);
            block[6].setText("M");
            block[6].setBackground(Color.ORANGE);
            block[7].setText("E");
            block[7].setBackground(Color.ORANGE);
            block[8].setText("O");
            block[8].setBackground(Color.ORANGE);
            block[9].setText("V");
            block[9].setBackground(Color.ORANGE);
            block[10].setText("E");
            block[10].setBackground(Color.ORANGE);
            block[11].setText("R");
            block[11].setBackground(Color.ORANGE);
    ...
    public void win()
    {
        ...
        block[0].setText("Y");
        block[0].setBackground(Color.GREEN);
        block[1].setText("O");
        block[1].setBackground(Color.GREEN);
        block[2].setText("U");
        block[2].setBackground(Color.GREEN);
        block[13].setText("W");
        block[13].setBackground(Color.GREEN);
        block[14].setText("I");
        block[14].setBackground(Color.GREEN);
        block[15].setText("N");
        block[15].setBackground(Color.GREEN);
